			...
			Nodes: []server.GatewayClusterNodeStatus{
				{
					...
					OK:   true,
					Status: &lsm.ClusterStatus{
						CommitLogRuntime: lsm.CommitLogRuntimeStatus{ApplyLag: 5},
					},
				},
				{
					Node: "node-b",
					OK:   true,
					Status: &lsm.ClusterStatus{
						CommitLogRuntime: lsm.CommitLogRuntimeStatus{ApplyLag: 1},
					},
				},
			},
		})
	...
	got := evaluateGatewayWait(server.GatewayClusterStatus{
		...
		Nodes: []server.GatewayClusterNodeStatus{
			...
			},
			{
				...
				OK:   true,
				Status: &lsm.ClusterStatus{
					CommitLogRuntime: lsm.CommitLogRuntimeStatus{ApplyLag: 3},
				},
			},
		},
	}, waitGatewayOptions{
