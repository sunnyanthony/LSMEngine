...
- `pkg/lsm/engine/commitlog.go`: control/data commit-log adapter and provider selection.
  ...
  - `etcd-raft`: real Raft propose/commit foundation for cluster-of-one, plus static peer bootstrap, outbound transport scaffolding, inbound peer-message handling, and manual ConfChange add/remove hooks.
