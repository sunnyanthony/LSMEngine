...
export LSM_GATEWAY_READY_MIN_REACHABLE="${LSM_GATEWAY_READY_MIN_REACHABLE:-3}"
export LSM_GATEWAY_READY_MAX_READ_APPLY_LAG="${LSM_GATEWAY_READY_MAX_READ_APPLY_LAG:-${LSM_GATEWAY_READ_READY_MAX_LAG:-2}}"
export LSM_GATEWAY_READY_MIN_READ_READY="${LSM_GATEWAY_READY_MIN_READ_READY:-${LSM_GATEWAY_READ_READY_MIN:-1}}"
GATEWAY_READ_READY_MIN="${LSM_GATEWAY_READ_READY_MIN:-$LSM_GATEWAY_READY_MIN_READ_READY}"
GATEWAY_READ_READY_MAX_LAG="${LSM_GATEWAY_READ_READY_MAX_LAG:-$LSM_GATEWAY_READY_MAX_READ_APPLY_LAG}"
